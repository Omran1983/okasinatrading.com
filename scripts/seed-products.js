// Quick Product Seeder - Run this to populate your store with sample products
// This will give you immediate content while we fix the Facebook import
...
async function seedProducts() {
    ...
    try {
        ...
        if (existing && existing.length > 0) {
            ...
            const proceed = confirm('Products already exist. Do you want to add more sample products anyway?');
            if (!proceed) {
